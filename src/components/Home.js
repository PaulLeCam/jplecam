  ...
  <Grid fluid className="home">
    ...
    <Row className="section-segment">
      <Col md={6}>
        ...
        <Link className="btn btn-default btn-block btn-lg" to="//paullecam.github.io/jplecam/professionnels/">Plus d'infos</Link>
      </Col>
      <Col md={6}>
        ...
        <Link className="btn btn-default btn-block btn-lg" to="//paullecam.github.io/jplecam/particuliers/">Plus d'infos</Link>
      </Col>
    </Row>
  </Grid>
);
